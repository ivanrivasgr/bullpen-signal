...
therefore under data/processed/ (untracked); write to dbt/seeds/ only
when the input is the full-season pull.
"""
...
def build(parquet_paths: list[str], seed_path: str, out_path: str) -> None:
...
def main() -> None:
    ...
    build(args.parquet, args.handedness_seed, args.out)
